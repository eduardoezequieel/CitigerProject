        ...
        <div id="cuadroContenido">
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <h1 class="tituloPagina">Listado de Visitas</h1>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-12 d-flex  align-items">
                    <h1 class="subTituloPagina">Ultimas Visitas</h1>
                </div>
            </div>
                        ...
                        <tbody>
                            <tr >
                                ...
                                <th scope="row" class="boto1">
                                    <a href="#" class="btn botonesListadoTabla "><i class="fas fa-eye  mr-3 tamañoIconosBotonesTabla1"></i>Ver</a>
                                </th>
                            </tr>
                            <tr>
