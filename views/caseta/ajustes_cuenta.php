                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="form-group w-xl-50 w-md-50">
                                ...
                                <input onChange="checkContrasena('txtContrasenaActualAuth')" type="password" class="form-control cajaTextoModal2" id="txtContrasenaActualAuth" name="txtContrasenaActualAuth" placeholder="" maxlength="60">
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="form-group w-xl-50 w-md-50">
                                ...
                                <input onChange="checkContrasena('txtPassword')" type="password" class="form-control cajaTextoModal2" id="txtPassword" name="txtPassword" placeholder="" maxlength="60">
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content justify-content-center px-3 py-2">
            ...
            <div class="textoModal px-3 pb-4 mt-2">
                ...
                <form method="post" autocomplete="off" id="username-form">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="form-group w-xl-50 w-md-50">
                                ...
                                <input onChange="checkContrasena('txtPassword2')" type="password" class="form-control cajaTextoModal2" id="txtPassword2" name="txtPassword2" placeholder="" maxlength="60">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mt-4">
                        <div class="col-12 d-flex justify-content-center align-items-center text-center">
                            <button type="submit" class="btn btnAgregarFormulario mr-2"><span class="fas fa-check mr-3 tamañoIconosBotones"></span>Actualizar Usuario</button>
                        </div>
                    </div>
                </form>
                <!-- Fin del Contenido del Modal -->
