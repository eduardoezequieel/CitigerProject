                ...
                <form method="post" id="Visitante-form" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control cajaTextoFormulario2" onchange="checkInput('txtPlaca')" id="txtPlaca" name="txtPlaca" placeholder="P123 456" maxlength="8">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <!-- Combobox, si se desea usar, copiar todo el div que incluye la clase
                                            cbCitiger, para cambiarle el tamaño, crear un id en cbCitiger y usar el width
                                            deseado en el combobox  -->
                            <div class="cbCitiger w-100" id="cbc2">
                                <select class="custom-select" id="cbVisitaR" name="cbVisitaR" onchange="checkCb('cbc2')">
                                    <option selected="default">Seleccionar...</option>
