                    ...
                    <div class="modal-content justify-content-center px-3 py-2">
                        ...
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title tituloModal" id="exampleModalLabel">
                                <span class="fas fa-info-circle mr-4 iconoModal"></span>Alquiler</h5>
                            <!-- Boton para Cerrar -->
                                ...
                                <div class="col-xl-7 col-md-7 col-sm-12 col-xs-12 marginPrimeraColumna centrarColumnas">
                                    <div id="EmpleadosColumna1">
                                        ...
                                        <input type="date" class="form-control cajaTextoFormulario" id="txtFecha" name="txtFecha" onchange="checkInput('txtFecha')"
                                            ...
                                            <label class="tituloCajaTextoFormulario" for="txtPrecio">Estado:</label>
                                        <input type="text" class="form-control cajaTextoFormularioPrecio" id="txtEstado6" name="txtEstado6"
                                            placeholder=""  onchange="checkInput('txtEstado6')" Required>
                                    </div>
