                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="cbCitiger" id="cbc1">
                                    <select class="custom-select" id="cbTipo" name="cbTipo"  onchange="checkCb('cbc1')">
                                        <option selected="">Seleccionar...</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
                                        <option value="3">Three</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control cajaTextoFormulario2" onchange="checkAlfanumerico('txtDescripcion')" placeholder="Escriba su descripcion..." id="txtDescripcion" name="txtDescripcion" rows="4" maxlength="200"></textarea>
