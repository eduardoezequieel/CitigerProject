                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-center col-xl-6 col-md-12 col-sm-12 col-xs-12  centrarColumnas">
                                <div class="form-group">
                                    ...
                                    <h1 class="tituloDato text-center">Nombre</h1>
                                    <h1 class="campoDato text-center mb-3" id="lblNombre">Cancha</h1>

                                    <h1 class="tituloDato text-center">Descripcion</h1>
                                    <h1 class="campoDato text-center mb-3" id="lblDesc">Activo</h1>
                                    <h1 class="tituloDato text-center">Capacidad</h1>
                                    <h1 class="campoDato text-center mb-3" id="lblCap">20</h1>
