        ...
        <div id="cuadroContenido">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-12 col-sm-12 col-xs-12 centrarBotones">
                    <a href="agregar_empleados.php" class="btn botonesListado"><span class="fas fa-plus mr-3 tamañoIconosBotones"></span>Agregar Nuevo Empleado</a>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="subTituloPagina pl-4 pb-3">Caseta</h2>
                </div>
                <div class="col">
