                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-md-6 col-sm-12 col-xs-12 mt-2 d-flex justify-content-center">
                            <div class="form-group">
                                <h1 class="tituloDato2 text-center">Residente:</h1>
                                <h1 class="campoDato text-center" id="lblResidente2">Eduardo Rivera</h1>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6 col-sm-12 col-xs-12 mt-2 d-flex justify-content-center">
                            <div class="form-group">
        ...
        <div class="modal-content justify-content-center px-3 py-2">
            ...
            <div class="textoModal modal-body px-3 pb-4 mt-2">
                ...
                <form method="post" id="verificarDui-form" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <button type="submit" class="btn btnAgregarFormulario mr-2"><span class="fas fa-chevron-right mr-3 tamañoIconosBotones"></span>Continuar</button>
                        </div>
                    </div>
                </form>
            </div>
