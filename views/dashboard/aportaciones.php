                ...
                <form method="post" id="adminCasa-form">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input onchange="checkAlfanumerico('txtNum')" type="text" class="form-control cajaTextoModal" id="txtNum" name="txtNum" placeholder="Escriba el número de casa..." required maxlength="3">
