        ...
        <div class="row justify-content-center mt-3 px-5 animate__animated animate__bounceIn">
            <div class="col-xl-12 d-flex justify-content-center col-md-12 col-sm-12 col-xs-12 centrarBotones">
                <div class="mt-4 mx-3 mb-3">
                    <a href="#" id="btnInsertDialog" data-toggle="modal" data-target="#administrarMarcas"
                ...
                <form class="mx-3 mb-2" method="post" id="search-form">
                    ...
                    <input type="text" class="form-control buscador" id="search" name="search"
                        aria-describedby="emailHelp" placeholder="{ Nombre de la marca }">
                </form>
                ...
                <div class="modal-content justify-content-center px-3 py-2">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title tituloModal" id="exampleModalLabel"><span
                                class="fas fa-info-circle mr-4 iconoModal"></span>Marcas</h5>
                        <!-- Boton para Cerrar -->
